...
public class ProfilePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("PROFILE PASSWORD");
    }
    ...
    private void goToSettings() {
        Intent intent = new Intent(ProfilePassword.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(ProfilePassword.this, Settings.class);
        startActivity(intent);
    }
