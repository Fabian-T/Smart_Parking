...
public class ProfileGender extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_profile_gender);
        getSupportActionBar().setTitle("PROFILE GENDER");
    }
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(ProfileGender.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(ProfileGender.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(ProfileGender.this, Settings.class);
        startActivity(intent);
    }
