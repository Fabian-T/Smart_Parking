...
public class MyWalletRequest extends AppCompatActivity {
    ...
    private void goToSettings() {
        Intent intent = new Intent(MyWalletRequest.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(MyWalletRequest.this, Settings.class);
        startActivity(intent);
    }

    private void goToOut() {
        Toast.makeText(getApplicationContext(), "Log Out Successful!", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(MyWalletRequest.this, LogIn.class);
        startActivity(intent);
    }
