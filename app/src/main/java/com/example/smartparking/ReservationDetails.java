...
public class ReservationDetails extends AppCompatActivity {
    ...
    private void goToSettings() {
        Intent intent = new Intent(ReservationDetails.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(ReservationDetails.this, Settings.class);
        startActivity(intent);
    }

    private void goToOut() {
        Toast.makeText(getApplicationContext(), "Log Out Successful!", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(ReservationDetails.this, LogIn.class);
        startActivity(intent);
    }
