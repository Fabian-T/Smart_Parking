...
public class CheckPayment extends AppCompatActivity {
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(CheckPayment.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(CheckPayment.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(CheckPayment.this, Settings.class);
        startActivity(intent);
    }
