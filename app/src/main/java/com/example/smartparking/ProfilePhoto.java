...
public class ProfilePhoto extends AppCompatActivity {
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(ProfilePhoto.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(ProfilePhoto.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(ProfilePhoto.this, Settings.class);
        startActivity(intent);
    }
