...
public class MyWalletTopUp extends AppCompatActivity {
    ...
    private void goToSettings() {
        Intent intent = new Intent(MyWalletTopUp.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(MyWalletTopUp.this, Settings.class);
        startActivity(intent);
    }
    private void goToOut() {
        Toast.makeText(getApplicationContext(), "Log Out Successful!", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(MyWalletTopUp.this, LogIn.class);
        startActivity(intent);
    }
