...
public class SettingsFAQ extends AppCompatActivity {
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(SettingsFAQ.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(SettingsFAQ.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(SettingsFAQ.this, Settings.class);
        startActivity(intent);
    }
}
