...
public class SettingsReport extends AppCompatActivity {
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(SettingsReport.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(SettingsReport.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(SettingsReport.this, Settings.class);
        startActivity(intent);
    }
