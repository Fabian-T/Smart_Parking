...
public class RateComments extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ratecomments);
        getSupportActionBar().setTitle("RATE AND COMMENTS");
}
    ...
    private void goToSettings() {
        Intent intent = new Intent(RateComments.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(RateComments.this, Settings.class);
        startActivity(intent);
    }
    private void goToOut() {
        Toast.makeText(getApplicationContext(), "Log Out Successful!", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(RateComments.this, LogIn.class);
        startActivity(intent);
    }
