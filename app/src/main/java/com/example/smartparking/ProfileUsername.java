...
public class ProfileUsername extends AppCompatActivity {
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(ProfileUsername.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(ProfileUsername.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(ProfileUsername.this, Settings.class);
        startActivity(intent);
    }
