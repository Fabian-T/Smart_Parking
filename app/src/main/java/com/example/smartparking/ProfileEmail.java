...
public class ProfileEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("PROFILE E-MAIL");
    }
    ...
    private void goToOut() {
        ...
        Intent intent = new Intent(ProfileEmail.this, LogIn.class);
        startActivity(intent);
    }
    private void goToSettings() {
        Intent intent = new Intent(ProfileEmail.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(ProfileEmail.this, Settings.class);
        startActivity(intent);
    }
