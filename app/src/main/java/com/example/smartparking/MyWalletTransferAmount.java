...
public class MyWalletTransferAmount extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_wallet_transfer_amount);
        getSupportActionBar().setTitle("TRANSFER AMOUNT");
    }
    ...
    private void goToSettings() {
        Intent intent = new Intent(MyWalletTransferAmount.this, Notification.class);
        startActivity(intent);
    }

    private void goToNotification() {
        Intent intent = new Intent(MyWalletTransferAmount.this, Settings.class);
        startActivity(intent);
    }
    private void goToOut() {
        Toast.makeText(getApplicationContext(), "Log Out Successful!", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(MyWalletTransferAmount.this, LogIn.class);
        startActivity(intent);
    }
